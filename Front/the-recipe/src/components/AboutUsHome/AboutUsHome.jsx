  ...
  return (
    <div>
      ...
      <section className="text-gray-600 body-font pt-10">
        <div className="container px-10 py-20 mx-auto 0 rounded-xl shadow-lg bg-gradient-to-r from-white via-slate-100 to-violet-50 bg-gradient-to-b">
          <div className="flex flex-wrap sm:-m-4 -mx-4 -mb-10 -mt-4 md:space-y-0 space-y-6">
            <div className="p-4 md:w-1/3 flex flex-col text-center items-center">
              <div className="w-20 h-20 inline-flex items-center justify-center rounded-full bg-transparent text-indigo-500 mb-5 flex-shrink-0">
                <img src="https://res.cloudinary.com/dc3pogjef/image/upload/v1693704290/icons8-salmon-sushi-94_zygr3z.png" alt="foodicon1" />
              </div>
